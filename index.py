...
def get_model():
    return genai.GenerativeModel("gemini-1.5-flash",
                                ...
                                if the user asks for a zodiac sign, you will use the data provided to generate informationabout the zodiac sign.
                                if the user asks for a birthday horoscope, you will use the data provided to generate a horoscope for the user's birthday.
                                if the user asks for a daily horoscope, you will use the data provided to generate a horoscope for the day.
                                if the user asks for a weekly horoscope, you will use the data provided to generate a horoscope for the week.
                                ...
                                Despite the questions being in English, you will always respond in Vietnamese.
...
def astrology_chatbot():
    ...
    st.write("Chào mừng bạn đến với AstroBot! Tôi có thể giúp bạn với các câu hỏi về chiêm tinh và cung hoàng đạo. Hãy hỏi tôi bất cứ điều gì!")
